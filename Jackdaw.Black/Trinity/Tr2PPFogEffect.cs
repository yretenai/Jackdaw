...
public class Tr2PPFogEffect : Tr2PPEffect, IRoot {
	...
	public Vector3D<float> AreaSize { get; set; }
	public Vector2D<float> AreaScale { get; set; }
	public Vector3D<float> AreaCenter { get; set; }
}
